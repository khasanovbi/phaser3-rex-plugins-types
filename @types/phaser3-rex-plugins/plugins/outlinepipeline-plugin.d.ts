declare module 'phaser3-rex-plugins/plugins/outlinepipeline-plugin' {
    import BasePostFxPipelinePlugin, {
        BasePostFxPipelineConfig,
    } from 'phaser3-rex-plugins/plugins/utils/renderer/BasePostFxPipelinePlugin';
